...
**You cannot** sell, sublicense, modify, redistribute, reverse-engineer, or incorporate this program into another product without express written permission.

This program is provided **"as is" without any warranties**. The developer does not guarantee it will be error-free, secure, compatible with your system, or continuously available.

**You are solely responsible** for determining if this program suits your needs and for backing up your data before use. By using this program, you assume all risk for any consequences, including data loss, system damage, security issues, or other damages. The developer is **not liable** for any direct or indirect damages arising from the program's use.

The developer provides **no updates, technical support, maintenance, or guaranteed availability**. Third-party components included in this program are subject to their own separate licenses.
